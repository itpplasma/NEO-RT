program test_potato_bounce
    ...
    call setup
    call test_potato_find_bounce_interface
    call test_potato_bounce_vs_thin
    call test_potato_bounce_direct_call
    ...
    end subroutine test_potato_find_bounce_interface
    
    subroutine test_potato_bounce_vs_thin
        ...
        real(8) :: taub_thick, bounceavg_thick(nvar)
        real(8) :: taub_thin, bounceavg_thin(nvar)
        
        print *, 'Testing POTATO bounce vs thin orbit comparison...'
        ...
        if (abs(taub_thick - taub_thin) < 1.0d-12) then
            print *, 'test_potato_bounce_vs_thin FAILED - thick and thin results identical'
            error stop
        end if
        
        print *, 'test_potato_bounce_vs_thin OK - thick orbit gives different results from thin'
    ...
    subroutine test_potato_bounce_direct_call
        ...
        if (delphi <= 0.0d0) then
            print *, 'test_potato_bounce_direct_call FAILED - invalid toroidal shift'
            error stop
        end if
        
        print *, 'test_potato_bounce_direct_call OK - direct POTATO call successful'
        
    end subroutine test_potato_bounce_direct_call
    
end program test_potato_bounce