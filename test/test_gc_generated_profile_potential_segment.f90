program test_gc_generated_profile_potential_segment
    ...
    real(dp) :: psihat, dpsihat_dstor, inverse_s_tor
    ...
    call evaluate_neort_eqdsk_flux_profile_segment(0.25_dp, 0.75_dp, 0.0_dp, &
        0.5_dp, 0.0_dp, 6.0_dp, 2.0_dp, 3.0_dp, psihat, dpsihat_dstor, &
        inverse_s_tor)
