...
module neort_eqdsk_allowed_energy_symbolic
    implicit none
    private
    public :: evaluate_neort_eqdsk_allowed_energy
contains

    pure subroutine evaluate_neort_eqdsk_allowed_energy(radius, field_scale, psi, psi_R, psi_Z, psi_RR, &
            psi_RZ, psi_ZZ, psi_RRR, psi_RRZ, psi_RZZ, psi_ZZZ, F, dF_dpsihat, d2F_dpsihat2, psi_sep, dZ_dR, &
            d2Z_dR2, h, J_K, mass, charge, c_light, electrostatic_potential, dPhi_dpsi, d2Phi_dpsi2, &
