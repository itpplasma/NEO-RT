...
module neort_full_fow_sign_symmetry_symbolic
    implicit none
    private
    public :: evaluate_neort_full_fow_sign_symmetry_ledger
contains

    pure subroutine evaluate_neort_full_fow_sign_symmetry_ledger(a_real, a_imag, m_mode, n_mode, theta, &
            phi, amplitude_phase, dpsi_star_dx, F_prime, Cdot, signed_R_Bparallel_star, h, charge, &
        ...
        t15 = m_mode*sign_omega_b
        t16 = n_mode*sign_omega_phi
        t17 = -charge*electrostatic_potential*2
        ...
        gauge_outer_residual = charge*t14 - (h + t13) - (charge*electrostatic_potential - h)
        toroidal_resonance_relabel_residual = t15 + t16 - (t15 + t16)
        toroidal_power_relabel_residual = 0
        toroidal_torque_component_difference = -sign_torque_phi*2
        charge_reversal_potential_energy_difference = t17
        potential_sign_reversal_energy_difference = t17
