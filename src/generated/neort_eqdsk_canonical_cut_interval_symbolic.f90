...
module neort_eqdsk_canonical_cut_interval_symbolic
    implicit none
    private
    public :: evaluate_neort_eqdsk_canonical_cut_interval
contains
...
end module neort_eqdsk_canonical_cut_interval_symbolic
