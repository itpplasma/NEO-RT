module neort_generated_certificate_registry
    ...
    integer, parameter :: certificate_count = 13
    ...
    character(len=64), parameter :: certificate_fingerprint(certificate_count) = &
        ...
        'neort-cert-v1:eqdsk_cell_jet:10:fortsym-77b0312', &
        'neort-cert-v1:eqdsk_profile_jet:4:fortsym-77b0312', &
        'neort-cert-v1:eqdsk_cut_jet:7:fortsym-77b0312' ]
