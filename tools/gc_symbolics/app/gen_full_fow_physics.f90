...
contains
    ...
    subroutine emit_certificate_registry(path)
        ...
        write (unit, "(a)") "        'fortsym@a2b9bb353816b03445282fc71d0584b34a787549'"
        ...
        write (unit, "(a)") "        [character(len=64) :: 'neort-cert-v1:geometry:19:fortsym-a2b9bb3', &"
        write (unit, "(a)") "        'neort-cert-v1:littlejohn:22:fortsym-a2b9bb3', &"
        write (unit, "(a)") "        'neort-cert-v1:eq13_cdot:3:fortsym-a2b9bb3', &"
        write (unit, "(a)") "        'neort-cert-v1:boundary_limits:13:fortsym-a2b9bb3', &"
        write (unit, "(a)") "        'neort-cert-v1:root_enclosures:3:fortsym-a2b9bb3', &"
        write (unit, "(a)") "        'neort-cert-v1:interpolation:9:fortsym-a2b9bb3', &"
        write (unit, "(a)") "        'neort-cert-v1:profile_endpoints:8:fortsym-a2b9bb3', &"
        write (unit, "(a)") "        'neort-cert-v1:refinement:14:fortsym-a2b9bb3', &"
        write (unit, "(a)") "        'neort-cert-v1:harmonic_integrand:8:fortsym-a2b9bb3', &"
        write (unit, "(a)") "        'neort-cert-v1:simple_root_force:3:fortsym-a2b9bb3' ]"
