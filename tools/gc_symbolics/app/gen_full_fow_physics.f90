program gen_full_fow_physics
    ...
    call check_identity(proofs, proof_engine, &
        ...
        subs(diff(allowed_bphi_local, allowed_x), allowed_x, zero) - &
        allowed_dbphi_covariant_dr)
    call check_identity(proofs, proof_engine, &
        "Eq13 covariant toroidal field ratio second derivative", &
        subs(diff(diff(allowed_bphi_local, allowed_x), allowed_x), &
        allowed_x, zero)-allowed_d2bphi_covariant_dr2)
    call check_identity(proofs, proof_engine, &
    ...
    call check_identity(proofs, proof_engine, &
        ...
        subs(diff(diff(allowed_psi_star_local, allowed_x), allowed_x), &
        allowed_x, zero)-allowed_d2psi_star_dr2)
    call check_identity(proofs, proof_engine, &
